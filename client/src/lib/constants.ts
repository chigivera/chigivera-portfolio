...
export const services = [
  {
    ...
    icon: "laptop-code",
    color: "primary",
    description: "Custom CRM solutions tailored to your business needs with advanced features and integrations.",
    features: [
  ...
  },
  {
    ...
    icon: "shopping-cart",
    color: "secondary",
    description: "High-performance online stores with seamless checkout experiences and inventory management.",
    features: [
  ...
  },
  {
    ...
    icon: "robot",
    color: "accent",
    description: "Intelligent AI solutions that automate processes and deliver actionable insights.",
    features: [
  ...
  },
  {
    ...
    icon: "graduation-cap",
    color: "primary",
    description: "Educational platforms with intuitive course creation, student management, and analytics.",
    features: [
  ...
  },
  {
    ...
    icon: "server",
    color: "secondary",
    description: "Streamlined deployment pipelines and infrastructure solutions for optimal performance.",
    features: [
  ...
  },
  {
    ...
    icon: "mobile-alt",
    color: "accent",
    description: "Cross-platform mobile applications with native performance and engaging UX.",
    features: [
...
export const projects = [
  ...
  },
  {
    ...
    description: "An interactive learning management system with gamification elements for corporate training.",
  ...
  },
  {
    ...
    description: "IoT mobile application for controlling smart home devices with voice commands and automation.",
  ...
  },
  {
    ...
    description: "Scalable cloud architecture with auto-scaling, monitoring, and self-healing capabilities.",
    image: "",
    isFeatured: false,
